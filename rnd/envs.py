...
from car_intersect_env_maker import makeCarIntersect
...
try:
    ...
    from env.common_envs_utils.env_wrappers import ImageToGreyScale
except:
    print("If you launch this from . folder, you probably will have some import problems.")
...
class AtariEnvironment(Environment):
    def __init__(
        ...
        if 'CarIntersect' in env_id:
            self.env = makeCarIntersect(env_kwargs.get('settings'))
        else:
            self.env = MaxAndSkipEnv(gym.make(env_id, **env_kwargs), is_render)
